import NavbarDrawer from './Appbar'
import './Main.css'
const Main = () => {
  return (
    <>
      <div>
        <header id="header">
          <div className="header-content-div">
            ...
            <nav  className='responsive-right-nav'>
        ...
        <main>
          ...
          <section id="varieties" className="sec-padding">
            ...
            <div className="sec-content-div flexible">
              ...
              <div className="tile">
                <img src="https://i.ibb.co/H4Cnh7v/american-trel.png" alt="photo of american trel apples" />
                <h4>American Trel</h4>
                <p>
          ...
          <section id="benefits" className="sec-padding">
            ...
            <div className="sec-content-div flexible">
              <iframe id="video" width={560} title="Benefits of Apple" height={315} src="https://www.youtube.com/embed/W_JOJNztrnI" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
            </div>
          </section>
          <section className="sec-padding" id="contact">
            ...
            <div className="sec-content-div flexible">
              ...
              <form id="form" action method="POST">
                ...
                <input type="submit" className="btn mt-4" id="submit" defaultValue="Know More" />
              </form>
            </div>
          </section>
        </main>
